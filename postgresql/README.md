...
docker exec -i postgresql psql -U iam_inference_db -d inference_db < /home/pacs-ai/pacs-ai-backend/api-pacs/infrastructures/database/postgresql/migrations/000002_create_inference_ingestion_run_results_schema.up.sql
```
