...
def create_age_distribution_plot(patient_age: int | None) -> str:
    ...
    fig.add_trace(
        go.Scatter(
            ...
            line={"color": "rgba(0, 255, 0, 0.8)", "width": 2},  # Bright green
    ...
    fig.update_layout(
        title={
            ...
            "font": {"size": 24, "color": "#00ff00", "family": "Arial Black"},
            "x": 0.5,
            "y": 0.95,
        },
        xaxis={
            ...
            "tickfont": {"family": "Arial", "color": "white"},
...
def create_series_summary_chart(vessels_data: list[dict]) -> str:
    ...
    fig.add_trace(
        go.Table(
            header={
                ...
                "font": {"color": "black", "size": 12, "family": "Arial Black"},
                "line_color": "black",
                "height": 35,
            },
            cells={
                ...
                "fill_color": [
                    ["rgb(20,20,20)", "rgb(30,30,30)"] * len(df)
    ...
    fig.update_layout(
        title={
            "text": "Series Summary",
            "font": {"size": 20, "color": "#00ff00", "family": "Arial Black"},
            "x": 0.5,
        },
        width=800,
...
def generate_vessel_report(
    vessels: list[tuple[str, str, float | None]], patient_age: int | None, display: bool = True
) -> str:
    """
    ...
    for series_number, vessel_type, lvef in vessels:
        ...
        vessel_data.append(
            {"vessel_type": vessel_type, "series_uid": series_number, "lvef": vessel_lvef}
        )
...
if __name__ == "__main__":
    ...
    report = generate_vessel_report(vessels=vessels_data, patient_age=65, display=True)
