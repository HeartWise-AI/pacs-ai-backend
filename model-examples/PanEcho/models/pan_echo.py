...
import numpy as np
import pandas as pd
from models.models import FrameTransformer, MultiTaskModel
...
class PanEcho:
    def __init__(
        ...
        backbone_only=False, 
        model_path='/app/content/panecho.pt',
        task_path='/app/content/tasks.pkl',
        tasks='all', 
        activations=True, 
        clip_len=16
    ):
        ...
        if pretrained:
            weights = torch.load(model_path, map_location='cpu', weights_only=True)['weights']
