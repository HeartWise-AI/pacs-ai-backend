...
class BasePredictionService:
    ...
    def reorient_labelmap(self, pred: nib.Nifti1Image, serie: List[pydicom.Dataset]) -> np.ndarray:
        """
        ...
        data = pred.get_fdata()
        labelmap_data = self._apply_orientation_transform(data, orientation_type)
