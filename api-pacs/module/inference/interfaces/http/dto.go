...
var (
	...
	ValidationErrors map[string]string   = map[string]string{
		...
		"StudyServiceProcessingCallbackRequest.EventID":                                                         "Event ID must be a UUID.",
		"StudyServiceProcessingCallbackRequest.Sequence":                                                        "Sequence must be greater than zero.",
	}
)
